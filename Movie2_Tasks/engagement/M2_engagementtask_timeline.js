...
// M2Clip1
timeline.push(disablemouse());
timeline.push(Experiment_Start_M2Clip1_Eng());
timeline.push(enablemouse());
...
// M2Clip2
timeline.push(disablemouse());
timeline.push(Experiment_Start_M2Clip2_Eng());
timeline.push(enablemouse());
...
// M2Clip3
timeline.push(disablemouse());
timeline.push(Experiment_Start_M2Clip3_Eng());
timeline.push(enablemouse());
...
// M2Clip4
timeline.push(disablemouse());
timeline.push(Experiment_Start_M2Clip4_Eng());
timeline.push(enablemouse());
...
timeline.push(movie2AttentionCheck());
