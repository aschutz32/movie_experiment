...
jsPsych.run([preload, preload_images, audiotest_trial, M4_Clips, browsercheck]);
...
// M4Clip1
timeline.push(disablemouse());
timeline.push(Experiment_Start_M4Clip1_Eng());
timeline.push(enablemouse());
...
// M4Clip2
timeline.push(disablemouse());
timeline.push(Experiment_Start_M4Clip2_Eng());
timeline.push(enablemouse());
...
// M4Clip3
timeline.push(disablemouse());
timeline.push(Experiment_Start_M4Clip3_Eng());
timeline.push(enablemouse());
...
// M4Clip4
timeline.push(disablemouse());
timeline.push(Experiment_Start_M4Clip4_Eng());
timeline.push(enablemouse());
...
timeline.push(movie4AttentionCheck());
