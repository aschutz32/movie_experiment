...
jsPsych.run([preload, preload_images, audiotest_trial, M3_Clips, browsercheck]);
...
// M3Clip1
timeline.push(disablemouse());
timeline.push(Experiment_Start_M3Clip1_Eng());
timeline.push(enablemouse());
...
// M3Clip2
timeline.push(disablemouse());
timeline.push(Experiment_Start_M3Clip2_Eng());
timeline.push(enablemouse());
...
// M3Clip3
timeline.push(disablemouse());
timeline.push(Experiment_Start_M3Clip3_Eng());
timeline.push(enablemouse());
...
// M3Clip4
timeline.push(disablemouse());
timeline.push(Experiment_Start_M3Clip4_Eng());
timeline.push(enablemouse());
...
// M3Clip5
timeline.push(disablemouse());
timeline.push(Experiment_Start_M3Clip5_Eng());
timeline.push(enablemouse());
...
timeline.push(movie3AttentionCheck());
